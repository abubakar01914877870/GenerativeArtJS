...
let artColors = ['#ff04ff', '##ffe66d', '#AF7AB3', '#D90429', '#EF233C', '#ff4d6d', '#ff758f'];
...
class Agent {
    ...
    update(context) {
        ...
        if (this.size == size) {
            ...
            noFill();
            stroke(color(0, 255, 255, 50));
            strokeWeight(3)
            ellipse(this.posX, this.posY, this.size + 20, this.size + 20);

            context.shadowBlur = random(this.size + 5);
            context.shadowColor = color(255, 0, 0, 50);
